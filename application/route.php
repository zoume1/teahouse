...
Route::group("",[
    ...
    "user_phone_bandage"=>"index/My/user_phone_bandage",//手机号绑定
    ...
    "consume_search"=>"index/Bill/consume_search",//账记录检索
    /*TODO:我的账单结束*/
    ...
    "inc_number"=>"index/Material/inc_number",                       //增加扫码次数
...
//    "order_refund"=>"admin/Api/order_refund",//微信退款
    ...
    "direct_seeding_statuse" =>"admin/Material/direct_seeding_statuse",                             //视频声音状态开启
    ...
    "create_good" =>"admin/Material/create_good",                                     //温湿感应列表删除
   ...
   "city_rank_search"=>"admin/City/city_rank_search",          //城市等级设置
...
Route::group("city",[
    ...
    "city_order_index"=>"city/CityOrder/city_order_index",//城市合伙人订单显示
