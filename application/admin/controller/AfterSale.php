...
//    }
        ...
        public function after_sale_refound(){
            ...
            $map['wallet_img']='';
            $goods_name=db('order')->where('id',$order_info['order_id'])->field('parts_goods_name,parys_order_number')->find();
            $map['title']=$goods_name['parts_goods_name'];
            $map['order_nums']=$goods_name['parts_order_number'];
            $map['pay_type']='小城序';
