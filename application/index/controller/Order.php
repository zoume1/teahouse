...
class  Order extends  Controller
{
    ...
    public function   ios_api_order_all(Request $request)
    {
        if ($request->isPost()) {
            ...
            $data = Db::name('order')
                ->field('parts_order_number,order_create_time,group_concat(id) order_id,status,special_id,order_quantity,upon_id,goods_id')
            ...
            if ($order_type['status'] == 1) {
                ...
                if ($res) {
                    ...
                    $datas = [
                        ...
                        "wallet_type" => -1, //消费操作(1入，-1出)
                        "operation_time" => date("Y-m-d H:i:s"), //操作时间
                        "operation_linux_time" => $order_pay_time, //操作时间
    ...
    public function templateMessage($params)
    {
        ...
        $secret = '4bc1912eb2cbab3e7b0bb0990b60036e';
        // 模板关键字
        $data = [];
